...
QUnit.module("SSR Render with basics", function(hooks) {
...
QUnit.module("SSR Render with portals", function(hooks) {
	hooks.beforeEach(function(assert){
		var done = assert.async();
		var test = this;
...
QUnit.module("SSR Render with route-data attribute", function(hooks) {
	hooks.beforeEach(function(assert){
		var done = assert.async();
...
QUnit.module("#renderInZone with basics", function(hooks) {
	hooks.beforeEach(function(assert){
		var done = assert.async();
		var test = this;
...
QUnit.module("SSR Route", function(hooks) {
	hooks.beforeEach(function(assert){
		var done = assert.async();
		var test = this;
...
QUnit.module("connectViewModelAndAttach", function(hooks) {
